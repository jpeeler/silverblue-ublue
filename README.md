...
[![build-ublue](https://github.com/jpeeler/silverblue-ublue/actions/workflows/build.yml/badge.svg)](https://github.com/jpeeler/silverblue-ublue/actions/workflows/build.yml)
...
> **Note**
> Everywhere in this repository, make sure to replace `jpeeler/silverblue-ublue` with the details of your own repository. Unless you used [`create-ublue-image`](https://github.com/EinoHR/create-ublue-image), in which case the previous repo identifier should already be your repo's details.
...
Read [the README in the `scripts/` directory](https://github.com/jpeeler/silverblue-ublue/blob/main/scripts/README.md) for more information.
...
```
sudo rpm-ostree rebase ostree-unverified-registry:ghcr.io/jpeeler/silverblue-ublue:latest
```

This repository builds date tags as well, so if you want to rebase to a particular day's build:

```
sudo rpm-ostree rebase ostree-unverified-registry:ghcr.io/jpeeler/silverblue-ublue:20230403
```
...
These images are signed with sisgstore's [cosign](https://docs.sigstore.dev/cosign/overview/). You can verify the signature by downloading the `cosign.pub` key from this repo and running the following command:
    ...
    cosign verify --key cosign.pub ghcr.io/jpeeler/silverblue-ublue
